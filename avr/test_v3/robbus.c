...
static volatile uint8_t robbusState;	//! state of the processing state machine
...
// this shadows the received address to the same memory (as they're not needed at the same time
